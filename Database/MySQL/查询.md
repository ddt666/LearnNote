...
```sql
-- 创建数据库
create database python_test_1 default charset=utf8;
...
- 内连接查询：查询的结果为两个表匹配到的数据
  ...
  ![image-20201204124741713](assets/image-20201204124741713.png)

- 右连接查询：查询的结果为两个表匹配到的数据，右表特有的数据，对于左表中不存在的数据使用null填充

  ![image-20201204124754616](assets/image-20201204124754616.png)

- 左连接查询：查询的结果为两个表匹配到的数据，左表特有的数据，对于右表中不存在的数据使用null填充

  ![image-20201204124815406](assets/image-20201204124815406.png)
